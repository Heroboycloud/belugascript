...
def gen_vid(filename):
    ...
    with open(image_paths_file, 'w', encoding="utf8", newline="\n") as file:
        ...
        last_image_path = input_folder_abs+ image_files[-1]
